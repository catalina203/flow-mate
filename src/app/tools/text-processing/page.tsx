    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">文本处理工具</h2>
          <p className="text-gray-600 mb-6">批量替换、格式化、关键词提取等功能</p>
          <Link href="/tools?category=文本处理" className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 inline-block">
            返回工具列表
          </Link>
        </div>
      </div>
